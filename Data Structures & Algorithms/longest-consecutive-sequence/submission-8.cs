public class Solution {
    public int LongestConsecutive(int[] nums) {
        ...
        foreach (var val in numsDistinct)
        {
            numbers += (Convert.ToString(val) + spacing);
        }
      
        Console.WriteLine("Longest Seq: (kinda) " + s); //debugging
        Console.WriteLine("Sorted Numbers: " + numbers); //debugging
